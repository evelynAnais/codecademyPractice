...
namespace MadLibs
{
  class Program
  {
    ...
    {
      /*
      This program is a madLib story
      Author: Evelyn 
      */


      // Let the user know that the program is starting:
      Console.WriteLine("Story has started!");
      ...
      Console.Write("Enter a first adj: ");
      string adj1 = Console.ReadLine();

      Console.Write("Enter a second adj: ");
      string adj2 = Console.ReadLine();

      Console.Write("Enter a third adj: ");
